...
header <- dashboardHeader(
  ...
  # CSS theme
  # fresh::use_theme(theme = "wwww/sass-styles.css")
  
  # navbarMenu(
  #   "Menu",
  #   menuItem("Fund Performance", tabName = "fund_performance"),
  #   menuItem("Yearly Fund Performance", tabName = "yearly_fund_performance"),
  #   menuItem("Death Rate", tabName = "death_rate"),
  #   menuItem("Monte Carlo Simulation", tabName = "monte_carlo_simulation")
  # )
...
body <- dashboardBody(
  ...
  #   
    ...
    # second tab
    tabItem("Yearly Fund Performance",
             h3("Plot"),
    ...
    # fourth tab
    tabItem("Monte Carlo Simulation",
             h3("Plot"),
             # plotOutput("cumulate_fund_performance_plot"
             #            
             #            ),
